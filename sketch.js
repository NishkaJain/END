...
function preload(){
  ...
  monkey_running =     loadAnimation("Monkey_01.png","Monkey_02.png","Monkey_03.png","Monkey_04.png","Monkey_05.png","Monkey_06.png","Monkey_07.png","Monkey_08.png","Monkey_09.png","Monkey_10.png");
   ...
   ObstaclesGroup_img = loadAnimation("stone.png");
  ObstaclesGroup1_img = loadAnimation("Banana.png");
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    ...
    ObstaclesGroup.addAnimation("stone", ObstaclesGroup_img);
    obstacle.scale = 0.15;
  ...
  if(frameCount % 60 === 0){  
    ...
    ObstaclesGroup1.addAnimation("banana", ObstaclesGroup1_img);
